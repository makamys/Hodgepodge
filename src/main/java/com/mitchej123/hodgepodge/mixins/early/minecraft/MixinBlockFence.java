...
public class MixinBlockFence {
     ...
     */
    @Overwrite
    public boolean shouldConnectTo(IBlockAccess world, int x, int y, int z) {
        ...
        return block == (BlockFence) (Object) this
                ...
                || block.getMaterial().isSolidBlocking() && block.isFullCube()
                        && block.getMaterial() != Material.PUMPKIN;
    }
}
